      ...
      <div className="landing-features-grid">
        <div className="landing-features-card">
          ...
          <p className="landing-features-desc">
            Access thousands of titles directly from MyAnimeList via the Jikan
            API. Find your next obsession instantly.
          </p>
        </div>
        <div className="landing-features-card">
          <div className="landing-features-icon">
          ...
          <p className="landing-features-desc">
            Move titles between Watch, Watching, and Watched with a satisfying
            drag. Your progress, visualized.
          </p>
        </div>
        <div className="landing-features-card">
          <div className="landing-features-icon">
          ...
          <p className="landing-features-desc">
            Your board is synced to your account. Pick up where you left off
